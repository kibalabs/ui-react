...
Atoms use elements and native components to build themable, stateful components. These components are intended to be used directly (or within molecules and organisms) to create a consistent UI.
...
Molecules use atoms, elements and native components to create more complex visual components.
