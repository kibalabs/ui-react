...
export const FullWidth: Story = {
  render: () => (
    <TabBar isFullWidth={true} selectedTabKey='1' onTabKeySelected={() => {}}>
      <TabBar.Item tabKey='1' text='First' />
      <TabBar.Item tabKey='2' text='Second' />
      <TabBar.Item tabKey='3' text='Third' />
    </TabBar>
...
export const AlignmentStart: Story = {
  render: () => (
    <TabBar contentAlignment={Alignment.Start} isFullWidth={false} selectedTabKey='1' onTabKeySelected={() => {}}>
      <TabBar.Item tabKey='1' text='First' />
      <TabBar.Item tabKey='2' text='Second' />
    </TabBar>
  ),
...
export const AlignmentCenter: Story = {
  render: () => (
    <TabBar contentAlignment={Alignment.Center} isFullWidth={false} selectedTabKey='1' onTabKeySelected={() => {}}>
      <TabBar.Item tabKey='1' text='First' />
      <TabBar.Item tabKey='2' text='Second' />
    </TabBar>
  ),
...
export const AlignmentEnd: Story = {
  render: () => (
    <TabBar contentAlignment={Alignment.End} isFullWidth={false} selectedTabKey='1' onTabKeySelected={() => {}}>
      <TabBar.Item tabKey='1' text='First' />
      <TabBar.Item tabKey='2' text='Second' />
    </TabBar>
  ),
...
export const LongText: Story = {
  render: () => (
    <TabBar isFullWidth={false} selectedTabKey='1' onTabKeySelected={() => {}}>
      <TabBar.Item tabKey='1' text='First' />
...
export const ManyTabs: Story = {
  render: () => (
    <TabBar selectedTabKey='0' onTabKeySelected={() => {}}>
